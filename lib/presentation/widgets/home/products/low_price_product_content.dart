...
class LowPriceProductContent extends GetView<HomeControllerImpl> {
  final ProductModel productModel;
  const LowPriceProductContent(
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextApp(
                        text: "\$${productModel.productPrice! - (productModel.productPrice! * productModel.productDiscount! /100)}",
                        fontSize: font16,
